...
2. Rebind "C-l" to be a prefix key. Good times for all.
3. Read and WRITE more elisp. Need this stuff.
4. Learn a bit of the 'dash library. May replace 'cl.
...
0. May already exist: Want to be able to just hit M-x file-diff or
   somethinglike that and have it show, in mycurrent buffer, the
   ...
   in a separate buffer if I want.
